classdef NumericalComputingWithMATLABApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/NumericalComputingWithMATLAB/code'};
    ...
    methods
        ...
        function startApp(obj)
            ...
            existVal = exist(fullfile(pwd,'ncmgui')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong ncmgui
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'ncmgui').getString, ...
